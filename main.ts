...
namespace ModuleWorld_Digital {
    ...
    export enum enObstacle {
        //% blockId="Obstacle" block="Obstaculo"
        Obstacle = 0,
        //% blockId="NoObstacle" block="NoObstaculo"
        NoObstacle = 1
    }
    ...
    export enum enPIR {
        ...
        NoPIR = 0,
        //% blockId="OPIR" block="PIR"
        OPIR = 1
    }

    export enum enCollision {
        //% blockId="NoCollision" block="NoColision"
        NoCollision = 0,
        //% blockId="OCollision" block="Colision"
        OCollision = 1
    }

    export enum enVibration {
        //% blockId="NoVibration" block="NoVibracion"
        NoVibration = 0,
        //% blockId="OVibration" block="Vibracion"
        OVibration = 1
    }
    ...
    export enum DHT11Type {
        ...
        //% block="temperatura(℉)" enumval=1
        DHT11_temperature_F,

        //% block="humedad(0~100)" enumval=2
        DHT11_humidity,
    }
    export enum enButton {
        //% blockId="Press" block="Presionado"
        Press = 0,
        //% blockId="Realse" block="Liberado"
        Realse = 1
    }	

	//% blockId="readdht11" block="valor de DHT11 %dht11type| en pin %value_DNum"
    //% weight=100
    //% blockGap=20
    ...
    //% blockId=ModuleWorld_Digital_Ultrasonic block="pin|Ultrasonico %value_DNum"
    //% weight=97
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=ModuleWorld_Digital_IR block="pin|IR %value_DNum|valor %value"
    //% weight=96
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=ModuleWorld_Digital_PIR block="pin|PIR %value_DNum|valor %value"
    //% weight=96
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=ModuleWorld_Digital_Collision block="pin|Colision %value_DNum|valor %value"
    //% weight=3
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=ModuleWorld_Digital_Button block="pin|Boton %value_DNum|valor %value"
    //% weight=3
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=ModuleWorld_Digital_Vibration block="pin|Vibracion %value_DNum|obtener "
    //% weight=1
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
...
namespace ModuleWorld_Analog {
    ...
    export enum enRocker {
        //% blockId="NoState" block="SinEstado"
        NoState = 0,
    ...
    //% blockId=ModuleWorld_Anaglog_Light block="pin|Fotoresistencia %value_ANum"
    //% weight=100
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5 
    ...
    //% blockId=ModuleWorld_Anaglog_Sound block="pin|Sonido %value_ANum"
    //% weight=99
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
	...
	//% blockId=ModuleWorld_Anaglog_Potentiometer block="pin|Potenciometro %value_ANum"
    //% weight=2
    //% blockGap=20
    ...
    //% blockId=ModuleWorld_Anaglog_Rocker block="pin|Joystick %value_ANum|valor %value"
    //% weight=1
    //% blockGap=20
...
namespace ModuleWorld_PWM {
    ...
    export enum enColor {
        ...
        White,
        //% blockId="Cyan" block="AzulCian"
        Cyan,
        //% blockId="Pinkish" block="Rosaceo"
        Pinkish,
    ...
    //% blockId=ModuleWorld_PWM_BuzzerPin block="establecer Pin Buzzer|%value_DNum"
    //% weight=99
    //% blockGap=22
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=ModuleWorld_PWM_VibrationMot block="Motor Vibracion|%value_DNum|velocidad %speed"
    //% weight=80
    //% blockGap=22
    ...
    //% blockId=ModuleWorld_PWM_RGB block="RGB|(P12P13P14)|valorR %value1|valorG %value2|valorB %value3"
    //% weight=2
    //% blockGap=20
    ...
    //% blockId=ModuleWorld_PWM_RGB2 block="RGB|(P12P13P14)|valor %value"
    //% weight=1
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=ModuleWorld_PWM_Servo block="pin|Servo(360) %ServoNum|valor %value"
    //% weight=6
    //% blockGap=20
    ...
    //% blockId=ModuleWorld_PWM_Servo2 block="pin|Servo(270) %ServoNum|valor %value"
    //% weight=6
    //% blockGap=20
